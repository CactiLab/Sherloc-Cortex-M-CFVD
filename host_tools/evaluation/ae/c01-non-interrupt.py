...
def main():
  ...
  SHERLOC_image = eval_elf_s + 'full_no_irq.axf'
  ...
  benchmark_image = eval_working_subpath + 'elf_ns/bubblesort.axf'
  ...
  benchmark_metadata = eval_working_subpath + 'metadata/bubblesort.bin'

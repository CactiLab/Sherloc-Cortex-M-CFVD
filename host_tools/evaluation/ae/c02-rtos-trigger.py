...
def main():
  ...
  SHERLOC_image = eval_elf_s + 'led_trigger.axf'
  ...
  benchmark_image = eval_working_subpath + 'elf_ns/FreeRTOS_MPU_ns_led.axf'
  ...
  benchmark_metadata = eval_working_subpath + 'metadata/FreeRTOS_MPU_ns_led.bin'

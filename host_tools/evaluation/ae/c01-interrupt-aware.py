...
def main():
  ...
  SHERLOC_image = eval_elf_s + 'full_blinky.axf'
  ...
  benchmark_image = eval_working_subpath + 'elf_ns/Sherloc_Blinky_ns_10ms.axf'
  ...
  benchmark_metadata = eval_working_subpath + 'metadata/Sherloc_Blinky_ns_10ms.bin'

...
class UVPROJXBuilderForTrigger(object):
    def __init__(self, proj_name, task_number, in_proj_path_ns, eval_trigger_src_path, out_uvprojx_path, out_binary_ns_path, out_tmp_path, opt_level):
        ...
        self.eval_trigger_src_path = eval_trigger_src_path
    ...
    def build_run(self):
        ...
        src_uvprojx = './led_trigger/FreeRTOS_MPU_ns_' + self.opt_level + '.uvprojx'
        ...
        if not os.path.exists(axf_file_path):
            ...
            src_main = f'{self.eval_trigger_src_path}{self.proj_name}_main.c'
...
class MetadataCreatorForTrigger(object):
